...
export const wedding = {
  ...
  // ── OUR STORY ─────────────────────────────────────────────────
  story: {
    intro: `We met at the beginning of the fall of 2024 at Texas Tech. Jed was almost done with his PhD and Dani was just starting that long journey. Different buildings, different schedules. Jed in Economics, deep in research on Japanese economic history. Dani in Chemical Engineering, working on sustainability. Different worlds, same campus.`,

    body: `Our first date was September 21, 2024, at J&B Café in Lubbock on a rainy afternoon. That day Dani handed Jed a small succulent she had been growing for a while, because she already had a good feeling about where things were going. J&B was packed with people escaping the rain, so we grabbed a table outside with a chai latte, a cold brew, and a blueberry muffin to share. When the rain came back we ran to the car, Tundry, and kept talking. We both knew something had started. A second date followed soon after. Jed, who had been paying attention, took Dani to a corn maze on a blazing hot day. We made it through, ate corn on the cob, and somewhere along the way Jed fought through every bug in that field to cut sunflowers for Dani, because he knew she loved them.`,

    adventures: `Our first Thanksgiving together we cooked a turkey for the first time, made deviled eggs, mashed potatoes, and a pear dessert. When December came, Jed invited Dani to spend the break in Las Vegas with his family. We packed the car and hit the road from Texas to Nevada, arriving to the warmest welcome from Jed's mom, his sister Autumn, and everyone around us. Dani felt part of the family from day one. It was a beautiful Christmas and New Year's, with Colombian traditions Dani brought along, like eating 12 grapes at midnight for 12 wishes and making arepitas. On the drive back we stopped in Flagstaff, Arizona, fell in love with the mountains, and it has stayed in our hearts ever since. Around that same time, Jed met Dani's family over the phone. With a few Spanish words, Dani's help with translation, and a lot of warmth on both sides, the conversation between Grandma Herminia, Mom Sandra, and Jed was sweet and genuine. They still ask about him every time and cannot wait to meet him in person. Then Jed graduated, a milestone we were all incredibly proud of, and moved to Omaha, Nebraska in the summer of 2025. With the distance between us, we held on to four things: God, love, communication, and respect. A nightly phone call became a tradition that has never been broken. Our second Thanksgiving came, our first anniversary arrived on a snowy night in Omaha, and through the years we have found ways to close the gap, making every visit count. The miles have never changed what matters most.`,
